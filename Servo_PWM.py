...
def DT_PWM_Speedrange():
	...
	DT_input_L = int(raw_input("Pls input what speed you want to run the right motor at: 4 = Forward_fastest, 3 = Foward_fast, 6 = Forward_veryslow,0 = stop, 2 = Reverse_fast, 1 = Reverse_fastest > "))
	if DT_input_L == 4:
